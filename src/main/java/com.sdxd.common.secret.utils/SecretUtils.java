package com.sdxd.common.secret.utils;
...
/**
 * Package Name: com.snda.common.secret.util
 * Description:
 * Author: qiuyangjun
...
public class SecretUtils {
    ...
    private static final String PASSWORD_CRYPT_KEY = "2016Shengdaxd";
...
//			return new String(c1.doFinal(Base64.decode(str)));
    ...
    public static String encryptMode(String str) {
        ...
        // 加密
        final byte[] secretArr = SecretUtils.encryptMode(str.getBytes(), PASSWORD_CRYPT_KEY);
...
//			return Base64.encode(secretArr);
    ...
    public static void main(String[] args) {
        ...
        // 加密
        final String secretArr = SecretUtils.encryptMode(msg, "123456789");
        System.out.println("【加密后】：" + secretArr);

        // 解密
        final String myMsgArr = SecretUtils.decryptMode(secretArr, "123456789");
